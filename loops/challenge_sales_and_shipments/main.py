...
for i in range(len(products)): #subtract the number of units sold (units_sold) from the products stock.
    products[i][1] -= units_sold[i][1]

for i in range(len(products)): #Add the corresponding value from shipment_received to update the stock.
